...
<head>
	...
	<script type="text/javascript">
		...
		function changeTextLinkCollapse()
		{
			...
			{
				document.getElementById('linkCollapse').innerHTML="<i class='fa fa-angle-double-left'></i> Mostrar menos campos";
			}
			else
			{
				document.getElementById('linkCollapse').innerHTML="<i class='fa fa-angle-double-right'></i> Mostrar más campos";
			}
		}
	</script>
					...
					<div class="col-lg-6">
						...
						<div class="form-group">
							<a id="linkCollapse" class="btn btn-default" role="button" data-toggle="collapse" href="#rowCollapse" aria-expanded="false" aria-controls="rowCollapse" onclick="changeTextLinkCollapse();">
							  <i class="fa fa-angle-double-right"></i> Mostrar más campos
							</a>
						</div>
					</div>
