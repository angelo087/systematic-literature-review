...
class MendeleyToolService /*implements IMendeleyService*/ {
		...
		List<SearchComponent> components, String minYear, String maxYear, String maxTotal, List<EngineSearch> engines)
	{
		...
		runAsync {
			...
			sendSearchNotification(strIdProfile, slrInstance, isSuccess)
		}
	...
	void sendSearchNotification(String strIdProfile, Slr slrInstance, boolean success)
	{
		...
		Long idProfile = Long.parseLong(strIdProfile)
		UserProfile userProfile = UserProfile.lock(idProfile)
		...
		List<SearchComponent> components, String minYear, String maxYear, String maxTotal, List<EngineSearch> engines)
	{
		...
		//sendSearchNotification(strIdProfile, slrInstance, success)
	}
